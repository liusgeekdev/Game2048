package com.lius.game2048.activity;
...
import com.lius.game2048.R;
import com.lius.game2048.config.Config;
import com.lius.game2048.view.GameView;

/**
 * @author: Chris Liu
 * @date: 2018/6/18  15:34
 * 可以优化的地方：1.换肤功能(改变小方块的显示背景)
 *                 2.后门(通过大距离的滑动来开启超级用户权限的作弊功能，增加游戏娱乐性)
 *                 3.增加SNS功能，可以跟大家一起玩
 */
